...
public class OrderWithCustomerSearch_IDAHO1 extends OrdersExecution3 {
	...
	/*	String  SubTotalText1=driver.findElement(By.cssSelector("#pad-wrapper > div:nth-child(11) > div > div > div > div.ng-scope > div > table > tfoot > tr.subtotals > td:nth-child(3) > strong")).getText();
		System.out.println(SubTotalText1);
...
/*	
   ...
   //Now Update the Phone Number
	...
	Thread.sleep(45000);
	String  SubTotalText=driver.findElement(By.cssSelector("#pad-wrapper > div:nth-child(11) > div > div > div > div.ng-scope > div > table > tfoot > tr.subtotals > td:nth-child(3) > strong")).getText();
