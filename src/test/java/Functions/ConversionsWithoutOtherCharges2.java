...
public class ConversionsWithoutOtherCharges2 extends OrdersExecution3 {
	...
	public static String OrderDetails_BillingAddress;
	public static String OrderDetails_ShippingAddress;
	public static String OrderDetails_AcknowledgementAddress;
...
public static void CanadianProduct_Subtotal_String_To_Int_Conversion() throws ParseException, InterruptedException{
...
public static void BillingAddress_EditRemove(){
	// This is to Instantiate EditOrders  class  
	OrdersLocators OrdernoConv = PageFactory.initElements(driver, OrdersLocators.class);
	
	OrderDetails_BillingAddress=OrdernoConv.CreateOrderScreen_BillingCompanyAddress.getText();
	
	OrderDetails_BillingAddress=OrderDetails_BillingAddress.replaceAll("[Edit]", "");
	
	System.out.println(OrderDetails_BillingAddress);

}
public static void ShippingAddress_EditRemove(){
	// This is to Instantiate EditOrders  class  
	OrdersLocators OrdernoConv = PageFactory.initElements(driver, OrdersLocators.class);
	
	OrderDetails_ShippingAddress=OrdernoConv.CreateOrderScreen_BillingCompanyAddress.getText();
	
	OrderDetails_ShippingAddress=OrderDetails_ShippingAddress.replaceAll("[Edit]", "");
	
	System.out.println(OrderDetails_ShippingAddress);
