...
import FunctionsWESP.Conversions;
...
public class OrderCreation_FromWespMultipleProd extends WESPORDER {
	...
	public static  void TaxAppliedonMultipleProductsAtCandaianAddress1() throws InterruptedException, IOException, ParseException{
	   	  ...
	   	  try{
	   		...
	   		//Go to ESP Web Tab
    //		  Click("Navigate to ESP Web", WespOrder.ESPWeb_Tab);
    		  Thread.sleep(5000);
    		...
    		/*  
    		  ...
    		  Thread.sleep(12000);  
	   		  */
    		  Click("Save to clipborad",  WespOrder.Order_SavetoclipboardButton);
	   	  ...
	   	  //Click the E-Comm order button now
	   		 // WespOrder.ShoppingCart_OrderButton.click();
	   		  Click("click at order button", WespOrder.ShoppingCart_OrderButton);
	   		  Thread.sleep(15000);
	     ...
	     for (int a=0; a<2; a++) {
			   ...
			   /*		
	    		  ...
	    		  if(record>=1) {
	    		  	...
	    		  	Thread.sleep(2000);
	    		  	Click("Click continue button", 	WespOrder.CreateOrder_Configure_Continue_Button);
	    		  	Thread.sleep(2000);
