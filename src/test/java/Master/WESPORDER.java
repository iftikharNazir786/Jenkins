...
public void getResult(ITestResult result){
		...
		if(result.getStatus()==ITestResult.SUCCESS){
			  ...
			  test.log(Status.PASS, MarkupHelper.createLabel(result.getName() +" Test Case is Passed", ExtentColor.GREEN)); test.log(Status.PASS,"Please see attached screenshot"); 
			  extent.flush();
...
try {
	...
	//Press the continue Button
	 ...
	 List<WebElement> li = driver.findElements(By.xpath("//span[contains(text(),'Enter or Select Company')]"));
